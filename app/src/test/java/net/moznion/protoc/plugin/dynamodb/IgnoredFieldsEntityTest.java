...
public class IgnoredFieldsEntityTest {
	...
	void shouldInsertAndLookupEntitySuccessfully() throws Exception {
		...
		final PaginatedQueryList<IgnoredFieldsEntityProto.IgnoredFieldsEntity.DynamoDBEntity> retrieved =
			dynamodbMapper.query(
				IgnoredFieldsEntityProto.IgnoredFieldsEntity.DynamoDBEntity.class,
				new DynamoDBQueryExpression<IgnoredFieldsEntityProto.IgnoredFieldsEntity.DynamoDBEntity>().withHashKeyValues(
					entity.toDynamoDBEntity())
			);
